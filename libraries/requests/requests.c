...
// GET
char *compute_get_request(char *host, char *url, char *query_params, char *JWT_token, 
...
char *compute_post_request(char *host, char *url, char* content_type, char **body_data,
                            int body_data_fields_count, char *JWT_token, char **cookies, int cookies_count)
{
    char *message = calloc(BUFLEN, sizeof(char));
    char *line = calloc(LINELEN, sizeof(char));
...
// DELETE
char *compute_delete_request(char *host, char *url, char *JWT_token, char **cookies, int cookies_count) {
    char *message = calloc(BUFLEN, sizeof(char));
    char *line = calloc(LINELEN, sizeof(char));
